...
import com.zhevol.library.zxing.google.client.BeepManager;
import com.zhevol.library.zxing.google.client.InactivityTimer;
import com.zhevol.library.zxing.google.client.Intents;
...
public class CaptureManager {
     ...
     * 解析二维码
     *
     * @param callback 解析的回调
     */
    public void decode(BarcodeCallback callback) {
        barcodeView.decodeSingle(callback);
    }
     ...
     */
    public String getBarcodeImagePath(BarcodeResult rawResult) {
