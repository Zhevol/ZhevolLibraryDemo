...
import com.zhevol.library.zxing.custom.camera.CameraInstance;
import com.zhevol.library.zxing.custom.camera.CameraSettings;
import com.zhevol.library.zxing.custom.camera.CameraSurface;
import com.zhevol.library.zxing.custom.camera.CenterCropStrategy;
import com.zhevol.library.zxing.custom.camera.DisplayConfiguration;
import com.zhevol.library.zxing.custom.camera.FitCenterStrategy;
import com.zhevol.library.zxing.custom.camera.FitXYStrategy;
import com.zhevol.library.zxing.custom.camera.PreviewScalingStrategy;
...
public class CameraPreview extends ViewGroup {
    ...
    private double marginFraction = 0.16d;
    ...
    protected Rect calculateFramingRect(Rect container, Rect surface) {
        ...
        //intersection.inset(margin, margin);//原本的

        //修改后的
        intersection.set(intersection.left + margin, intersection.top + margin / 2,
                intersection.right - margin, intersection.bottom - margin * 3 / 2);
